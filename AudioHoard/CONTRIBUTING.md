# Contributing to AudioHoard

Thanks for your interest in contributing! All skill levels are welcome.

## Before You Start

- Check existing [issues](https://github.com/nyakuoff/AudioHoard/issues) and [pull requests](https://github.com/nyakuoff/AudioHoard/pulls) to avoid duplicating work.
...
- Your OS and AudioHoard version
...
AudioHoard supports multiple languages through JSON files in `src/renderer/locales/`.
