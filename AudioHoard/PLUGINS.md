...
AudioHoard supports curated plugins from the marketplace. This document explains the plugin format, the official monorepo, and how third-party developers can submit plugins.

## Plugin Types

| Type | Repo | Tag in app |
|---|---|---|
| **Official** | [nyakuoff/AudioHoard-Plugins](https://github.com/nyakuoff/AudioHoard-Plugins) (monorepo) | `Official` |
...
- **Official plugins** live as subdirectories in the `nyakuoff/AudioHoard-Plugins` monorepo.
...
| `minAppVersion` | No | Minimum AudioHoard version required |
...
3. Open a Pull Request on [nyakuoff/AudioHoard](https://github.com/nyakuoff/AudioHoard) adding your entry to `plugins/registry.json`
...
```json
{
  ...
  "version": "1.0.0",
  "icon": "🔌",
  "repo": "your-username/AudioHoard-my-plugin"
}
```
...
```json
{
  ...
  "author": "AudioHoard Team",
  "version": "1.0.0",
  "icon": "📻",
  "repo": "nyakuoff/AudioHoard-Plugins",
  "path": "internet-radio",
  "official": true
}
```
...
| `official` | No | `true` for official AudioHoard plugins |
