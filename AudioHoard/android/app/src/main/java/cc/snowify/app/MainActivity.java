...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.i("AudioHoard", "Audio proxy running on port " + PROXY_PORT);
        } catch (IOException e) {
            Log.e("AudioHoard", "Failed to start audio proxy", e);
        }
    }
    ...
    static final class AudioProxyServer extends NanoHTTPD {
        ...
        public Response serve(IHTTPSession session) {
            ...
            Log.d("AudioHoard", "Proxy request [range=" + incomingRange + "]: "
            ...
            try {
                ...
                Log.d("AudioHoard", "Proxy upstream: status=" + statusCode
                        + " mime=" + mimeType
                ...
                Log.e("AudioHoard", "Proxy error for: " + realUrl, e);
