...
let _npSideCollapsed = true;
try {
  const storedNPSideCollapsed = localStorage.getItem(NP_SIDE_COLLAPSED_KEY);
  _npSideCollapsed = storedNPSideCollapsed == null ? true : storedNPSideCollapsed === '1';
} catch {}
