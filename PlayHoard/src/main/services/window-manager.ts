...
const shouldOpenDevTools = () =>
  process.env.PLAYHOARD_OPEN_DEVTOOLS === "1" || isStaging;

const appIcon = process.platform === "win32" ? iconIco : icon;
...
export class WindowManager {
  ...
  public static async createMainWindow() {
    ...
    const initialHash = userPreferences?.launchToLibraryPage
      ? "library"
      : "catalogue";
    ...
    this.mainWindow.on("ready-to-show", () => {
      if (shouldOpenDevTools()) WindowManager.mainWindow?.webContents.openDevTools();
