...
const parseContentHoardJson = (value?: string) => {
...
contextBridge.exposeInMainWorld("electron", {
  contentHoard: {
    ...
    writeSharedState: (state: unknown) => ipcRenderer.invoke("contenthoard:write-shared-state", state),
    onSharedStateUpdated: (callback: (state: unknown) => void) => {
