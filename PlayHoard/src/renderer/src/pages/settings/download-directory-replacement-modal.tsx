...
export function DownloadDirectoryReplacementModal({
  ...
  return (
    <Modal
      ...
      description="Your saved download directory list is full. Choose which saved directory to replace with the new default path."
      onClose={onClose}
    >
      <div className="download-directory-replacement-modal">
        ...
        <div className="download-directory-replacement-modal__controls">
          <SelectField
            ...
            label="Replace this saved directory"
