  ...
  return (
    <div className="settings-context-panel">
      <div className="settings-context-panel__group">
        ...
        <SelectField
          label={t("default_home_page", {
            defaultValue: "Default home page",
          })}
          value={form.launchToLibraryPage ? "library" : "catalogue"}
          onChange={(event) =>
            handleChange({
              launchToLibraryPage: event.target.value === "library",
            })
          }
          options={[
            {
